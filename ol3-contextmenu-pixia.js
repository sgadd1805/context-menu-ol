/*!
 * PIXIA OpenLayers Context Menu library -- based on:
 *
...
//     return (new Date().getTime()).toString(36);
    ...
    Internal.prototype.setListeners = function setListeners () {
        if (this.Base.options.eventType === eventType.MOUSEUP) {
            this.contextMenuHandler = function(e) {
                e.stopPropagation();
                e.preventDefault();
            };
            this.Base.container.addEventListener(this.Base.options.eventType, this.contextMenuHandler, false);
        }
        this.viewport.addEventListener(this.Base.options.eventType, this.eventHandler, false);
    };

    Internal.prototype.removeListeners = function removeListeners () {
        if (this.Base.options.eventType === eventType.MOUSEUP) {
            this.viewport.removeEventListener(this.Base.options.eventType, this.contextMenuHandler, false);
        }

        this.viewport.removeEventListener(this.Base.options.eventType, this.eventHandler, false);
    };
    ...
    Internal.prototype.handleEvent = function handleEvent (evt) {
        ...
        if (this.Base.options.eventType === eventType.CONTEXTMENU ||
            this.Base.options.eventType === eventType.MOUSEUP) {
